...
class CheckSlots:
	...
	def __init__(self):
		...
		self.slots = {
					'B03F1B':[3.768, -10.88, 0, 1.2575, 1.23, 0.4, 0, 0],
					'B03F2B':[3.768, -10.88, 1.23, 1.2575, 1.23, 0.4, 0,  0],
					'B03F3B':[3.768, -10.88, 2.46, 1.2575, 0.94  , 0.4, 0, 0],
					'B03F1A':[2.515, -10.88, 0, 1.2575, 1.23, 0.4, 0, 0],
					'B03F2A':[2.515, -10.88, 1.23, 1.2575, 1.23, 0.4, 0, 0],
					'B03F3A':[2.515, -10.88, 2.46, 1.2575, 0.94  , 0.4, 0, 0],
					'B03E1B':[1.2575, -10.88, 0, 1.2575, 1.23, 0.4, 0, 0],
					'B03E2B':[1.2575, -10.88, 1.23, 1.2575, 1.23, 0.4, 0, 0],
					'B03E3B':[1.2575, -10.88, 2.46, 1.2575, 0.94  , 0.4, 0, 0],
					'B03E1A':[0, -10.88, 0, 1.2575, 1.23, 0.4, 0, 0],
					'B03E2A':[0, -10.88, 1.23, 1.2575, 1.23, 0.4, 0, 0],
					'B03E3A':[0, -10.88, 2.46, 1.2575, 0.94  , 0.4, 0, 0]
					}
	...
	def octomap_pcl_callback(self, msg):
		...
		print " %s %8d %8d %8d %8d" % ("3", self.slots["B03E3A"][6], self.slots["B03E3B"][6], self.slots["B03F3A"][6], self.slots["B03F3B"][6])
		print " %s %8d %8d %8d %8d" % ("2", self.slots["B03E2A"][6], self.slots["B03E2B"][6], self.slots["B03F2A"][6], self.slots["B03F2B"][6])
		print " %s %8d %8d %8d %8d" % ("1", self.slots["B03E1A"][6], self.slots["B03E1B"][6], self.slots["B03F1A"][6], self.slots["B03F1B"][6])
		print "\npercent(%):"
		print " %s %8.1f %8.1f %8.1f %8.1f" % ("3", pos((self.slots["B03E3A"][6]-self.bias)/self.den*1.33), pos((self.slots["B03E3B"][6]-self.bias)/self.den*1.33), pos((self.slots["B03F3A"][6]-self.bias)/self.den*1.33), pos((self.slots["B03F3B"][6]-self.bias)/self.den*1.33))
		print " %s %8.1f %8.1f %8.1f %8.1f" % ("2", pos((self.slots["B03E2A"][6]-self.bias)/self.den), pos((self.slots["B03E2B"][6]-self.bias)/self.den), pos((self.slots["B03F2A"][6]-self.bias)/self.den), pos((self.slots["B03F2B"][6]-self.bias)/self.den))
		print " %s %8.1f %8.1f %8.1f %8.1f" % ("1", pos((self.slots["B03E1A"][6]-self.bias1)/self.den), pos((self.slots["B03E1B"][6]-self.bias1)/self.den), pos((self.slots["B03F1A"][6]-self.bias1)/self.den), pos((self.slots["B03F1B"][6]-self.bias1)/self.den))
